...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/data/pul/.Xil/Vivado-7948-DESKTOP-2UDQTB7/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      C:/data/pul/project_1.srcs/sources_1/new/spi_master.vhd
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/data/pul/.Xil/Vivado-7948-DESKTOP-2UDQTB7/"
