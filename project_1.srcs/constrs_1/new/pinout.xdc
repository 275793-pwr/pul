...
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmens[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmentDigits[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmentDigits[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmentDigits[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {SevenSegmentDigits[0]}]
